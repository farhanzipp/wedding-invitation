  ...
  return (
    <section id="section-3" className="flex flex-col justify-center py-2 bg-pink-900">
        <div className="w-5/6 mx-auto text-orange-200">
          ...
          <p className='text-sm'>Merupakan suatu kehormatan dan kebahagiaan bagi kami, apabila Bapak/Ibu/Saudara/i berkenan hadir dalam acara kami. Atas kehadiran dan doa restunya, kami mengucapkan terima kasih</p>
