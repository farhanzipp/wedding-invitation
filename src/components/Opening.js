...
const Opening = () => {
  ...
  return (
    <section id="section-1" className="flex h-screen pt-16 pb-16 justify-center font-body">
        <div>
            ...
            <div className="w-3/4 mx-auto ">
                ...
                <Slide>
                  <h2 id="couple-name" className="relative text-center bottom-14 text-2xl text-pink-900 font-display">
                      <span className="py-1 px-3 bg-orange-200 shadow-md text-3xl"> {weddingData.groom.surname} & {weddingData.bride.surname}</span>
                  </h2>
                </Slide>
            </div>
            <p className="w-4/5 -mt-3 mx-auto text-sm">Kami mengharapkan kehadiran Anda di hari istimewa kami pada:</p>
